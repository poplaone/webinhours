            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  By accessing and using WebInHours ("we," "our," or "us"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  WebInHours provides a platform for rapid website development and deployment, connecting customers with professional web developers and offering pre-built templates. Our services include:
                </p>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 text-gray-600 space-y-2">
                  ...
                  <li>WebInHours retains rights to our platform and technology</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 text-gray-600 space-y-2">
                  ...
                  <li>Revenue sharing is 70% to seller, 30% to WebInHours</li>
              ...
              <section>
                ...
                <p className="text-gray-600 mb-4">
                  WebInHours shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.
                </p>
              </section>
