...
const Services = () => {
  ...
  return (
    <AppLayout>
      <SEOHead 
        title="Professional Website Development Services - Fast & Affordable"
        description="Professional website development services delivered in 24-48 hours. E-commerce, business, portfolio websites with mobile optimization, SEO, and hosting included."
        keywords="website development services, professional web design, e-commerce websites, business websites, portfolio websites, mobile websites"
      />
        ...
        <div className="container mx-auto">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Professional Website <span className="text-[#8B5CF6]">Development Services</span>
            </h1>
          ...
          >
            {services.map((service, index) => (
              ...
              >
                <Card className={`h-full border-border/40 bg-card/50 backdrop-blur hover:shadow-xl transition-all duration-500 hover:-translate-y-2 ${
                  service.popular ? 'border-[#8B5CF6]/30 ring-1 ring-[#8B5CF6]/20' : 'hover:border-[#8B5CF6]/30'
                }`}>
                  {service.popular && (
                    <Badge className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-[#8B5CF6] text-white">
                      Most Popular
                    </Badge>
                  )}
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="space-y-3">
                      <Button 
                        className="w-full bg-[#8B5CF6] hover:bg-[#7C3AED] group/btn"
                      ...
                      <Button 
                        variant="outline" 
                        className="w-full hover:bg-[#8B5CF6] hover:text-white hover:border-[#8B5CF6]"
            ...
            <Card className="p-8 border-[#8B5CF6]/20 bg-gradient-to-br from-[#8B5CF6]/5 to-[#A78BFA]/5">
              <CardContent className="p-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    { title: "Lightning Fast", desc: "24-48 hour delivery guaranteed", icon: Zap },
                    { title: "Professional Quality", desc: "No templates, custom development", icon: Star },
                    { title: "All Inclusive", desc: "Hosting, SSL, mobile optimization", icon: CheckCircle },
                    { title: "Money-Back Guarantee", desc: "30-day satisfaction guarantee", icon: Building2 }
                  ].map((item, index) => (
