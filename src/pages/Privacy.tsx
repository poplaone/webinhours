...
export default function Privacy() {
  return (
    <AppLayout>
      <SEOHead
        title="Privacy Policy - WebInHour | Your Privacy Matters"
        description="Learn how WebInHour protects your privacy and handles your personal information."
              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <p className="text-gray-600">
                    Email: privacy@webinhour.com<br />
