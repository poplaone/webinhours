      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-0">
        ...
        <div className="grid grid-rows-2 gap-0">
          ...
          <div className="grid sm:grid-cols-2 rounded-none bg-card">
            <FeatureCard icon={<Megaphone className="w-4 h-4" />} title="PR & Media" subtitle="Premium Services" description="Press releases, media outreach, and brand reputation management." />
            <FeatureCard icon={<Flower className="w-4 h-4" />} title="Website Care" subtitle="Monthly Maintenance" description="Priority support, security monitoring, and performance optimization." />
          </div>
        </div>
      </div>
    </section>;
...
function FeatureCard({
  ...
  return <div className="relative flex flex-col gap-2 md:gap-3 p-4 md:p-6 border border-border bg-background transition min-h-[200px] md:min-h-[250px]">
