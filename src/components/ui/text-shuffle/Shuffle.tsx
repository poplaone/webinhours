  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        tempSpan.style.cssText = window.getComputedStyle(el).cssText;
        tempSpan.style.position = 'absolute';
        tempSpan.style.visibility = 'hidden';
        tempSpan.textContent = 'M';
        document.body.appendChild(tempSpan);
        const avgWidth = tempSpan.getBoundingClientRect().width;
        ...
        chars.forEach(char => {
          ...
          origChar.textContent = char;
          origChar.setAttribute('data-orig', '1');
          Object.assign(origChar.style, { display: 'inline-block', width: w + 'px', textAlign: 'center' });
      ...
      const inners = () => wrappersRef.current.map(w => w.firstElementChild).filter(Boolean) as HTMLElement[];
