...
import { Shield, Zap, Smartphone, Layout } from 'lucide-react';

export function FeatureInfographicCards() {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 w-full">
        ...
        <CardContent className="p-4 sm:p-6">
          <div className="relative mx-auto flex flex-col items-center">
            <div className="relative flex h-16 w-16 sm:h-20 sm:w-20 items-center mb-3">
              ...
              <span className="mx-auto block w-fit text-2xl sm:text-3xl font-bold">500+</span>
            </div>
            <h3 className="text-xs sm:text-sm font-semibold text-center">Templates</h3>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="relative col-span-1 overflow-hidden bg-transparent border-border/40">
        <CardContent className="p-4 sm:p-6">
          ...
          <h3 className="text-xs sm:text-sm font-semibold text-center">Mobile Responsive</h3>
        </CardContent>
      </Card>
      ...
      <Card className="relative col-span-1 overflow-hidden bg-transparent border-border/40">
        <CardContent className="p-4 sm:p-6">
          ...
          <h3 className="text-xs sm:text-sm font-semibold text-center">SSL Security</h3>
        </CardContent>
      </Card>
      ...
      <Card className="relative col-span-1 overflow-hidden bg-transparent border-border/40">
        <CardContent className="p-4 sm:p-6">
          ...
          <h3 className="text-xs sm:text-sm font-semibold text-center">Lightning Fast</h3>
        </CardContent>
      </Card>
    </div>
  );
