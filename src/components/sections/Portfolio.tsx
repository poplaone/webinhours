...
export const Portfolio = () => {
  ...
  const categories = [
    ...
    { id: 'landing', name: 'Landing Pages', count: 6 }
  ];
  ...
  const projects = [
    {
      ...
      liveUrl: "#",
      githubUrl: "#",
      metrics: { conversion: "+180%", speed: "98/100", revenue: "$50K+" },
    ...
    },
    {
      ...
      liveUrl: "#",
      githubUrl: "#",
      metrics: { leads: "+250%", traffic: "+120%", ranking: "Top 3" },
    ...
    },
    {
      ...
      liveUrl: "#",
      githubUrl: "#",
      metrics: { conversion: "+320%", ctr: "12.5%", leads: "500+" },
    ...
    <section className="py-20 px-4 relative z-10">
      <div className="container mx-auto">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-4 text-center">
                      {Object.entries(project.metrics).map(([key, value]) => (
                        <div key={key} className="bg-[#8B5CF6]/10 rounded-lg p-2">
        ...
        >
          <Button 
            size="lg"
            className="bg-[#8B5CF6] hover:bg-[#7C3AED] text-lg px-8 py-4 transition-all duration-300 hover:scale-105"
          >
