...
export const Hero = () => {
  ...
  return (
    <section className="relume-hero-section">
        ...
        <div className="relume-hero-grid">
          ...
          <div className="relume-hero-column">
            <img 
              ...
              alt="Design preview"
              className="relume-hero-image parallax-image"
              data-depth="0.15"
            />
            <img 
              src="/assets/card-2.png" 
              alt="Mobile designs"
              className="relume-hero-image is-offset-left parallax-image"
              data-depth="0.25"
            />
            <img 
          ...
          <div className="relume-hero-center">
            ...
            <h1 className="relume-hero-heading">
            ...
            <Button 
              ...
              className="mt-8 bg-primary hover:bg-primary/90 text-primary-foreground text-lg px-10 py-7 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 font-semibold"
            >
          ...
          <div className="relume-hero-column">
            ...
            <img 
              ...
              className="relume-hero-image is-offset-right parallax-image"
              data-depth="0.22"
            />
            <img 
