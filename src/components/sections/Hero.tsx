      ...
      <div className="relume-hero-container">
        <div className="relume-hero-grid">
          ...
          <div className="relume-hero-column" aria-hidden="true">
            <img src="/assets/card-1.webp" alt="Professional website design preview" style={{
              width: 'auto',
              height: 'auto',
              maxWidth: '100%'
            }} data-depth="0.15" loading="eager" className="relume-hero-image parallax-image object-contain" />
            <img alt="E-commerce website template example" style={{
              width: 'auto',
              height: 'auto',
              maxWidth: '100%'
            ...
            <img src="/assets/card-3.webp" alt="Portfolio website template example" className="relume-hero-image parallax-image object-contain" style={{
              width: 'auto',
              height: 'auto',
              maxWidth: '100%'
          ...
          {/* RIGHT COLUMN */}
          <div className="relume-hero-column" aria-hidden="true">
            <img src="/assets/card-4.webp" alt="AI workflow platform template" style={{
              width: 'auto',
              height: 'auto',
              maxWidth: '100%'
            }} data-depth="0.18" loading="eager" className="relume-hero-image parallax-image object-contain" />
            <img src="/assets/card-5.webp" alt="Mobile app design template" className="relume-hero-image is-offset-right parallax-image object-contain" style={{
              width: 'auto',
              height: 'auto',
              maxWidth: '100%'
            }} data-depth="0.22" loading="eager" />
            <img src="/assets/card-6.webp" alt="Tech landing page template" style={{
              width: 'auto',
              height: 'auto',
              maxWidth: '100%'
            ...
            <img src="/assets/cursor-mario.png" alt="" className="relume-hero-cursor parallax-cursor" style={{
              ...
              top: '10px',
              right: '180px'
            }} data-depth="0.35" aria-hidden="true" />
          </div>
