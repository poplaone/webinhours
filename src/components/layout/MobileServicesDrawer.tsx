                ...
                <div className="p-4 overflow-y-auto">
                    ...
                    >
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs font-semibold text-primary uppercase tracking-wider">Live Network</span>
                        </div>
                        <div className="font-semibold text-sm text-foreground mb-1">Premium Digital Solutions</div>
