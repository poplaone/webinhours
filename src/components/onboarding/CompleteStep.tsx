...
const CompleteStep: React.FC = () => {
  return (
    <div className="space-y-6 text-center">
      ...
      >
        <div className="w-20 h-20 rounded-full bg-[#6353E6] flex items-center justify-center">
      ...
      >
        <div className="glass-card p-4 rounded-xl">
          <div className="w-10 h-10 rounded-lg bg-[#6353E6]/20 flex items-center justify-center mx-auto mb-3">
